    ...
    $('#dowebok').fullpage({
		...
		afterLoad: function(anchorLink,index){
			...
			if(index==2){
				...
				$("#about_info").animate({width:"800px",marginTop:"0",marginBottom:"0"},1000,'easeOutElastic',function(){
...
// 图片轮播
	...
	$("#exp_list_slider_content").mouseenter(function(){
		$("#exp_list_to").stop(true,false).fadeTo(1000,1);
	}).mouseleave(function(){
		$("#exp_list_to").stop(true,false).fadeTo(1000,0.1);	
	})
	var page=1;
